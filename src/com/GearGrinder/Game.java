...
public class Game extends Canvas implements Runnable {
	...
	public void render() {
		...
		if (hours < 10) g.drawString("TIME: 0" + hours + ":" + minutes + ":" + seconds, width / 2, 100);
		else if (minutes < 10) g.drawString("TIME: " + hours + ":0" + minutes + ":" + seconds, width / 2, 100);
		else if (seconds < 10) g.drawString("TIME: " + hours + ":" + minutes + ":0" + seconds, width / 2, 100);
		else if (hours < 10 && minutes < 10 && seconds < 10) g.drawString("TIME: 0" + hours + ":0" + minutes + ":0" + seconds, width / 2, 100);
		else if (hours < 10 && minutes < 10) g.drawString("TIME: 0" + hours + ":0" + minutes + ":" + seconds, width / 2, 100);
		else if (hours < 10 && seconds < 10) g.drawString("TIME: 0" + hours + ":" + minutes + ":0" + seconds, width / 2, 100);
		else if (minutes < 10 && seconds < 10) g.drawString("TIME: " + hours + ":0" + minutes + ":0" + seconds, width / 2, 100);
		else g.drawString("TIME: " + hours + ":" + minutes + ":" + seconds, width / 2, 100);
