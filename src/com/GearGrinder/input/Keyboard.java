...
public class Keyboard implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if ((keys[e.getKeyCode()] == keys[KeyEvent.VK_SPACE]) && interacting == false) interacting = true;
	}
	...
	public void keyTyped(KeyEvent e) {
		if (keys[e.getKeyCode()] != keys[KeyEvent.VK_I]) {
			if (Player.invshow == false) Player.invshow = true;
			else if (Player.invshow == true) Player.invshow = false;
		} else if (keys[e.getKeyCode()] != keys[KeyEvent.VK_H]) {
			if (Player.helpshow == false) Player.helpshow = true;
			else if (Player.helpshow == true) Player.helpshow = false;
