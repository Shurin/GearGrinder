...
public class Tile {
	...
	public static Tile spawn_grass_tile = new SpawnGrassTile(Sprite.spawn_grass);//0xFF00FE00
	public static Tile spawn_hedge_tile = new SpawnHedgeTile(Sprite.spawn_hedge);//0xFF2B6A00
	public static Tile spawn_water_tile = new SpawnWaterTile(Sprite.spawn_water);//0xFF0026FF
	public static Tile spawn_wall1_tile = new SpawnWallTile(Sprite.spawn_wall1);//0xFF808080
	public static Tile spawn_wall2_tile = new SpawnWallTile(Sprite.spawn_wall2);//0xFF404040
	public static Tile spawn_floor_tile = new SpawnFloorTile(Sprite.spawn_floor);//0xFFFF6A00
