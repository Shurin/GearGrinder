...
public class Player extends Mob {
	...
	public static void spritefix() {
		if (InitialStat.PSprite.equals("psprite001")) animSprite = down;
		else if (InitialStat.PSprite.equals("psprite002")) animSprite = down2;
	}

	public Player(Keyboard input) {
		this.input = input;
		if (InitialStat.PSprite.equals("psprite001")) sprite = Sprite.player_down;
		else if (InitialStat.PSprite.equals("psprite002")) sprite = Sprite.player2_down;
	}
	...
	public void update() {
		...
		if (input.up) {
			if (InitialStat.PSprite.equals("psprite001")) animSprite = up;
			else if (InitialStat.PSprite.equals("psprite002")) animSprite = up2;
		...
		if (input.right) {
			if (InitialStat.PSprite.equals("psprite001")) animSprite = right;
			else if (InitialStat.PSprite.equals("psprite002")) animSprite = right2;
			...
			if (InitialStat.PSprite.equals("psprite001")) animSprite = left;
			else if (InitialStat.PSprite.equals("psprite002")) animSprite = left2;
